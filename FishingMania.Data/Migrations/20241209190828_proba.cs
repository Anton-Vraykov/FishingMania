    ...
    public partial class proba : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypesFishings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FishingPlaces_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                    ...
                    table.ForeignKey(
                        ...
                        principalTable: "TypesFishings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "ApplicationUsersFishingPlaces",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUsersFishingPlaces", x => new { x.ApplicationUserId, x.FishingPlaceId });
                    table.ForeignKey(
                        name: "FK_ApplicationUsersFishingPlaces_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Location = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    AvelableCars = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUsersFishingPlaces_FishingPlaceId",
                table: "ApplicationUsersFishingPlaces",
